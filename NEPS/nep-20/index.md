...
The uniqueness of NEAT is defined by a combination of transactional channel C, asset _a_, time _t_, and a hashcode of Executing Condition h(E). In practice, all NEAT must have access to collaboral asset CA, and a set of reimbusement rule RR given different conditions during breach of contract.
...
| _a_           | Asset IDs : (Asset ID)_ ":" (Asset ID)_                                                                                                                                                                                                | a represents the set of (Asset ID)\* to be transferred to from x to y                                                                                                                                                                                                                                                              |
| _t_           | Time: (Newchain timestamp)+                                                                                                                                                                                                            | A sequence of timepoints of actual transactional events marked by (Newchain timestamp)+                                                                                                                                                                                                                                            |
